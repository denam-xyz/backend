    ...
    <div className="align-middle text-center text-banner -mt-12">
      <div className="h-screen flex ">
        <div className="grow space-y-12 self-center">
          ...
          <h4 className="text-2xl font-bold dark:text-white pt-20 pb-8">
            Search for decentralized names with our verified integrations
          </h4>
          <div className="flex justify-evenly relative">
            <img className="h-12" src={pns} alt="image description" />
            <img
              className="h-11"
              src={unstoppable_domains}
              alt="image description"
            />
            <img className="h-7" src={space_id} alt="image description" />
            <img
              className="h-11 rounded-lg"
              src={ens}
              alt="image description"
            />
            <img className="h-10" src={near} alt="image description" />
          </div>
        </div>
      </div>
      <div className="flex bg-gray-900 text-white h-screen pt-20 pb-2">
        <div className="grow self-center">
          ...
          <p className="mb-6 mt-6 text-lg font-extrabold  font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
          ...
          <div className="flex justify-evenly m-20">
            <div className="p-8">
              ...
              <p className="mb-3 text-lg font-light text-gray-400 md:text-xl dark:text-gray-400">
          ...
          <h3 className="text-3xl font-bold dark:text-white">
            Connecting your{" "}
            <mark className="px-1 text-gray-900 bg-white rounded dark:bg-gray-900 dark:text-white">
              web3 name
            </mark>
          </h3>
        </div>
